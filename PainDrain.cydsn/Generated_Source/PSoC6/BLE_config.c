...
static uint8_t cy_ble_attValues[0x35u] = {
    /* Device Name */
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Du] = {
    ...
    { 0x0014u, (void *)&cy_ble_attValues[33] }, /* Custom Characteristic */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x18u] = {
    ...
    { 0x0018u, 0x36A2u /* Custom Characteristic               */, 0x090E0101u /* rd,wr,wwr */, 0x0018u, {{0x0014u, (void *)&cy_ble_attValuesLen[12]}} },
};
